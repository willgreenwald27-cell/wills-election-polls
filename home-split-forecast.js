(()=>{
  ...
  function makeSenateCard(){
    ...
    card.innerHTML=`
      ...
      <div class="will-split-parties">
        <div><strong class="dem">DEMOCRATS: 50</strong><span>SEATS</span></div>
        <div class="right"><strong class="rep">REPUBLICANS: 50</strong><span>SEATS</span></div>
      </div>
      <div class="will-split-bar"><i class="dem-bar"></i><i class="rep-bar"></i><b class="majority-line"></b></div>
      <div class="will-split-bar-labels"><strong>50</strong><strong>50</strong></div>
      <div class="will-split-majority">51 majority</div>
      <div class="will-split-legend"><span><i class="dem-dot"></i>Democrats<br><small>50 seats</small></span><span><i class="rep-dot"></i>Republicans<br><small>50 seats</small></span></div>`;
    return card;
  }
  ...
  function style(){
    ...
    s.textContent=`
      ...
      #housePrediction2026 .will-senate-card{padding:24px 25px 20px;display:flex;flex-direction:column;justify-content:center;color:${NAVY};border:1px solid #e2e7ee}
      ...
      #housePrediction2026 .will-split-bar i{display:block;height:100%;width:50%}
      #housePrediction2026 .dem-bar{background:${BLUE}} #housePrediction2026 .rep-bar{background:${RED}}
      #housePrediction2026 .majority-line{position:absolute;left:51%;top:-8px;bottom:-24px;width:2px;border-left:2px dashed #596a80;z-index:3}
